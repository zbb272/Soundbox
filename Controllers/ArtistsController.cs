...
namespace Soundbox.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(SoundboxContext context)
        {
            _context = context;
        }
        ...
        {
            var artists = _context.Artist.Select(a => new Models.Artist
            {
                Id = a.Id,
                Name = a.Name,
                Age = a.Age,
            ...
            return Json(artists.ToDataSourceResult(request));
        }
        ...
        {
            if (_context.Artist.Any(a => a.Name == name))
            {
